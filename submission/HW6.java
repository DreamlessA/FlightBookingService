...
public class HW6 {
  ...
  public static JavaRDD<Row> Q2 (SparkSession spark, String dataFile) {
    ...
    JavaRDD<Row> ans = d
            .filter(t -> t.get(ORIGIN_CITY_NAME).equals("Seattle, WA"))
  ...
  public static JavaPairRDD<Tuple2<String, Integer>, Integer> Q3 (SparkSession spark, String dataFile) {
    ...
    JavaPairRDD<Tuple2<String, Integer>, Integer> ans = d
            .filter(t -> t.get(CANCELLED).equals(0))
            .keyBy(t -> new Tuple2<String, Integer>((String)t.get(ORIGIN_CITY_NAME), (Integer)t.get(MONTH)))
            .mapValues(t -> 1)
  ...
  static class tuple2Comparator implements Serializable, Comparator<Tuple2<String, Integer> >{
    @Override
  ...
  public static Tuple2<String, Integer> Q4 (SparkSession spark, String dataFile) {
    ...
    Tuple2<String, Integer> ans = d
            .keyBy(t -> (String)t.get(ORIGIN_CITY_NAME))
            .mapValues(t -> t.get(DEST_CITY_NAME))
            .distinct()
            .mapValues(t -> 1)
            .reduceByKey((t1,t2) -> t1+t2)
            .max(new tuple2Comparator());
  ...
  public static JavaPairRDD<String, Double> Q5 (SparkSession spark, String dataFile) {
    ...
    // your code here
    JavaPairRDD<String, Double> ans = d
            .filter(t -> t.get(DEP_DELAY) != null)
            .keyBy(t -> (String)t.get(ORIGIN_CITY_NAME))
            .mapValues(t -> RowFactory.create(t.get(DEP_DELAY),1))
            .reduceByKey((t1,t2) -> RowFactory.create((Integer)t1.get(0)+(Integer)t2.get(0),(Integer)t1.get(1)+(Integer)t2.get(1)))
            .mapValues(t -> (Integer)t.get(0)*1.0/(Integer)t.get(1));
